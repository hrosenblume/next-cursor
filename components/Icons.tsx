 ...
 * 
 * Why use this instead of lucide-react directly?
 * - Smaller bundle: Only includes icons we actually use
 * - Consistent sizing: All icons have sensible defaults
 * - Easy to customize: Add/modify icons in one place
 * 
 * Usage:
 *   import { ChevronLeftIcon, SunIcon } from '@/components/Icons'
